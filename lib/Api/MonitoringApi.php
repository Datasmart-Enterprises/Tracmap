...
class MonitoringApi
{
    ...
    {
        $this->heartbeatGetWithHttpInfo();
    }

    /**
     * Operation heartbeatGetWithHttpInfo
     *
     * Retrieves API operational state.
     *
     *
     ...
     */
    public function heartbeatGetWithHttpInfo()
    {
        $returnType = '';
        $request = $this->heartbeatGetRequest();
     ...
     */
    public function heartbeatGetAsync()
    {
        return $this->heartbeatGetAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation heartbeatGetAsyncWithHttpInfo
     *
     * Retrieves API operational state.
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function heartbeatGetAsyncWithHttpInfo()
    {
        $returnType = '';
        $request = $this->heartbeatGetRequest();
    ...
    /**
     * Create request for operation 'heartbeatGet'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function heartbeatGetRequest()
    {
