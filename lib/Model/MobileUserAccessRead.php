...
/**
 * MobileUserAccessRead Class Doc Comment
 *
 * @category Class
 * @package  Tracmap
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MobileUserAccessRead implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Mobile_User_Access_Read';
     ...
     * Sets accessToken
     *
     * @param string $accessToken Access token to be encrypted and used by the client application.
     *
     * @return $this
     */
